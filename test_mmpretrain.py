...
def parse_args():
    ...
    parser.add_argument('config', default=r"/data2/lyh/Diseases_lzz/code/mmpretrain/configs/shufflenet_v2/shufflenet-v2-1x_16xb64_in1k.py", help='test config file path')
    parser.add_argument('checkpoint', default=r"/data2/lyh/Diseases_lzz/weight_CAMUS/mmpretrain_onlyfeature/shufflenetv2_onlyfeature_8gpu/epoch_100.pth",help='checkpoint file')
    parser.add_argument(
        '--work-dir',
        default="/data2/lyh/Diseases_lzz/weight_CAMUS/mmpretrain_onlyfeature/shufflenetv2_onlyfeature_8gpu",
