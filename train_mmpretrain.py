...
def parse_args():
    ...
    parser.add_argument('config', default="/data2/lyh/Diseases_lzz/code/mmpretrain/configs/shufflenet_v2/shufflenet-v2-1x_16xb64_in1k.py", help='train config file path')
    parser.add_argument('--work-dir', default="/data2/lyh/Diseases_lzz/weight_CAMUS/mmpretrain_onlyfeature/shufflenetv2_onlyfeature", help='the dir to save logs and models')
    parser.add_argument(
        '--resume',
        nargs='?',
        type=str,
